- 👋 Hi, I’m @rflibrary (Thư viện RF - Hệ sinh thái tri thức tự vận hành)
- 👀 I’m interested in kiến tạo Hệ sinh thái giao thoa hoàn hảo giữa công nghệ phần cứng (Cyber-Physical Systems), Trí tuệ nhân tạo cục bộ (Local AI/RAG), và nhân sinh quan dựa trên mô hình H.E.I (Humanity - Engineering - Intelligence).
- 🌱 I’m currently learning cách tối ưu hóa thông qua "Trí tuệ thích ứng" (Adaptive Intelligence) — liên tục tự học từ dữ liệu viễn trắc (IoT/RFID) để điều phối tài nguyên và duy trì quỹ đạo phát triển bền vững.
